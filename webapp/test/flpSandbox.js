		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "KaraFi",
									"targetURL": "#comkarafikaraficlient-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comkarafikaraficlient-display": {
								"semanticObject": "comkarafikaraficlient",
								"action": "display",
								"description": "KaraFi Application",
								"title": "KaraFi",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.karafi.karaficlient",
									"url": sap.ui.require.toUrl("com/karafi/karaficlient")
								}
							}
						}
					}
